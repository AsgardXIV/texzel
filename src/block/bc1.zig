...
test "bc1 decompress" {
...

    {
        ...
        const decompress_result = try helpers.decodeBlock(allocator, BC1Block, RGBA8U, dimensions, read_result, .{});
...
test "bc1 compress" {
...

    {
        ...
        const compressed = try helpers.encodeBlock(allocator, BC1Block, RGBA8U, rgba_image, .{});
        defer allocator.free(compressed);

        const hash = std.hash.Crc32.hash(compressed);

        const expected_hash = 0x20EB9DDB;
