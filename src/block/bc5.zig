...
test "bc5 decompress" {
...

    {
        ...
        const decompress_result = try helpers.decodeBlock(allocator, BC5Block, RG8U, dimensions, read_result, .{});
...
test "bc5 compress" {
...

    {
        ...
        const compressed = try helpers.encodeBlock(allocator, BC5Block, RG8U, rgba_image, .{});
